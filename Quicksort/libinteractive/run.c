...
pipe_description pipe_descriptions[NUM_PIPES] = {
	{ "\\\\.\\pipe\\libinteractive_Main_quicksort_out", "\\\\.\\pipe\\libinteractive_quicksort_quicksort_out" },
	{ "\\\\.\\pipe\\libinteractive_quicksort_quicksort_in", "\\\\.\\pipe\\libinteractive_Main_quicksort_in" },
};

char* const commands[] = {
	"\"libinteractive\\Main\\Main.exe\"",
	"\"libinteractive\\quicksort\\quicksort.exe\"",
};
char* const debug_commands[] = {
	"\"libinteractive\\Main\\Main.exe\"",
	"\"gdbserver.exe\" \"127.0.0.1:8042\" \"libinteractive\\quicksort\\quicksort_debug.exe\"",
};
