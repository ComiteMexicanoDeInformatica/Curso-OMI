...
pipe_description pipe_descriptions[NUM_PIPES] = {
	{ "\\\\.\\pipe\\libinteractive_Main_AdivinaElNumero_out", "\\\\.\\pipe\\libinteractive_AdivinaElNumero_AdivinaElNumero_out" },
	{ "\\\\.\\pipe\\libinteractive_AdivinaElNumero_AdivinaElNumero_in", "\\\\.\\pipe\\libinteractive_Main_AdivinaElNumero_in" },
};

char* const commands[] = {
	"\"libinteractive\\Main\\Main.exe\"",
	"\"libinteractive\\AdivinaElNumero\\AdivinaElNumero.exe\"",
};
char* const debug_commands[] = {
	"\"libinteractive\\Main\\Main.exe\"",
	"\"gdbserver.exe\" \"127.0.0.1:8042\" \"libinteractive\\AdivinaElNumero\\AdivinaElNumero_debug.exe\"",
};
