...
SET TARGET=libinteractive\AdivinaElNumero\AdivinaElNumero.exe
SET SOURCES=DeCuartoEnCuarto.cpp libinteractive\AdivinaElNumero\AdivinaElNumero_entry.cpp
call:recompile %TARGET% %SOURCES%
IF "%RECOMPILE%" == "1" (
<NUL SET /p elidenewline=Compiling %TARGET%... 
%GXX% -std=c++11 -o %TARGET% %SOURCES% -lm -O2 -g  -Wno-unused-result -Ilibinteractive\AdivinaElNumero
IF !ERRORLEVEL! NEQ 0 EXIT /B !ERRORLEVEL!
ECHO DONE
)

SET TARGET=libinteractive\AdivinaElNumero\AdivinaElNumero_debug.exe
SET SOURCES=DeCuartoEnCuarto.cpp libinteractive\AdivinaElNumero\AdivinaElNumero_entry.cpp
call:recompile %TARGET% %SOURCES%
IF "%RECOMPILE%" == "1" (
<NUL SET /p elidenewline=Compiling %TARGET%... 
%GXX% -std=c++11 -o %TARGET% %SOURCES% -lm -g  -Wno-unused-result -Ilibinteractive\AdivinaElNumero
IF !ERRORLEVEL! NEQ 0 EXIT /B !ERRORLEVEL!
ECHO DONE
)
