...
pipe_description pipe_descriptions[NUM_PIPES] = {
	{ "\\\\.\\pipe\\libinteractive_Main_ColaInteractivo_out", "\\\\.\\pipe\\libinteractive_ColaInteractivo_ColaInteractivo_out" },
	{ "\\\\.\\pipe\\libinteractive_ColaInteractivo_ColaInteractivo_in", "\\\\.\\pipe\\libinteractive_Main_ColaInteractivo_in" },
};

char* const commands[] = {
	"\"libinteractive\\Main\\Main.exe\"",
	"\"libinteractive\\ColaInteractivo\\ColaInteractivo.exe\"",
};
char* const debug_commands[] = {
	"\"libinteractive\\Main\\Main.exe\"",
	"\"gdbserver.exe\" \"127.0.0.1:8042\" \"libinteractive\\ColaInteractivo\\ColaInteractivo_debug.exe\"",
};
