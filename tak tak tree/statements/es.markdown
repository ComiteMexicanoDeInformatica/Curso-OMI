...
2 56
||description
En el tercer ejemplo, 14 no es un buen número para el festival. Después de dos Lunas llenas, el número de frutos se ha cuadruplicado, convirtiéndose en $56=5\times11+1$. Este es un buen número para el festival.
||end
